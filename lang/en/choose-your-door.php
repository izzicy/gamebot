...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Fixed win phrases that can be chosen for choose your door.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Fixed lose phrases that can be chosen for choose your door.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Variable win phrases that contain a thing and a place.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | A list of things that can be won.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | A list of places at which things can be won.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Variable lose phrases that contain a thing and a place.
    |
    */
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | A list of places at which you can lose.
    |
    */
